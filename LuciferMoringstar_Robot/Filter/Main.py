...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if files:
            ...
            await client.send_sticker(chat_id=message.from_user.id, sticker='CAACAgIAAxkBAAEE7fJiny--c72FKIEL9Wb9EoN3c1Q0pgACvwEAAhZCawovE0xX2FzjziQE')
            return
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🖥️ channel 🖥️', url=f'{TUTORIAL}')
                    ]
                    ]
